...
const Stage4 = (props) => {
  ...
  const [value1, setValue1] = useState(["Dil Bilikləriniz"]);
//   console.log(value1);
      ...
      <div className={classes.education}>
        ...
        <form onSubmit={submitHandler}>
          <div className={classes.educations__controls}>
            ...
            {(value1[0]?.value === "ingilis" ||
              value1[1]?.value === "ingilis") &&
              selectValues.confirmlang1 === "yes" && (
                <>
                  <label>
            ...
            {selectValues.confirmlang1 === "yes" &&
              ((value1[0]?.value === "rus" && value1[1]?.value === 'ingilis') || (value1[0]?.value === "ingilis" && value1[1]?.value === "rus")) && (
                <>
            ...
            {/* {selectValues.confirmlang1 === "yes" &&
              ((value1[0]?.value === "rus" && value1[1]?.value === "ingilis") || (value1[0]?.value === "ingilis" && value1[1]?.value === "rus")) &&  */}
              {selectValues.confirmlang1 === "yes" &&
              (value1[0]?.value === "rus" || value1[1]?.value === "rus") &&
